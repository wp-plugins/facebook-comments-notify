...
1. Upload `fbcomments-notify` directory to the `/wp-content/plugins/` directory
...
== Changelog ==
= 0.4 =
* Added WP Editor on 'Text Email Notification'
* Now, the comments also are being saved in the database wordpress
* Some bug fixes
...
* Added ignore_user_abort, solving bug close the page before completing the notification
* Some bug fixes

= 0.1 =
* Fisrt Version of the plugin